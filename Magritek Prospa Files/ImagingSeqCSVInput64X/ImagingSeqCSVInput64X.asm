...
TTL3            ds      1       ; 32 - Byte 3
TTL8            ds      1       ; 33 - Byte 8
WAITRegulator_0         ds      1       ; 34 - Wait steps Regulator
WAITRegulator_1         ds      1       ; 35 - Wait unit1 Regulator
WAITRegulator_2         ds      1       ; 36 - Wait unit2 Regulator
TXA90            ds      1       ; 37 - Tx amplitude 90 word 0
TXP1            ds      1       ; 38 - Tx phase 1
DELAYRF90          ds      1       ; 39 - Delay RF90
NRGradZ             ds      1       ; 40 - Number GradZ
NRZGradAmplitude             ds      1       ; 41 - Number ZGradAmplitude
NRGradX             ds      1       ; 42 - Number GradX
NRXGradAmplitude             ds      1       ; 43 - Number XGradAmplitude
DELAYXGrad          ds      1       ; 44 - Delay XGrad
DELAYDeltaGrad          ds      1       ; 45 - Delay DeltaGrad
TXA180            ds      1       ; 46 - Tx amplitude 180 word 0
TXP2            ds      1       ; 47 - Tx phase 2
DELAYRF180          ds      1       ; 48 - Delay RF180
DELAYEncoding          ds      1       ; 49 - Delay Encoding
NREchoes             ds      1       ; 50 - Number Echoes
DELAY180_acq          ds      1       ; 51 - Delay 180_acq
NRPnts             ds      1       ; 52 - Number Pnts
DELAYAcq          ds      1       ; 53 - Delay Acq
NRDummy             ds      1       ; 54 - Number Dummy
DELAYDummy          ds      1       ; 55 - Delay Dummy
...
;***************************************************************************
; Set TTL level
        move    x:TTL3,a1              ; Read in the new TTL byte
...
;***************************************************************************
; Set TTL level
        move    x:TTL8,a1              ; Read in the new TTL byte
        move    y:TTL,x1                ; Read in the current TTL state
        or      x1,a1                   ; Combine with current TTL state
        move    a1,y:TTL                ; Save total TTL state
        move    a1,x:FPGA_TTL           ; Update TTL output
...
; General delay
        clr     a
        move    x:WAITRegulator_0,a1            ; Number of delay steps
        move    a1,r1
        move    x:WAITRegulator_1,a1            ; Delay size 1
        rep     a
        nop
        clr     a
        move    x:WAITRegulator_2,a1            ; Delay size 2
...
;***************************************************************************
; Set TTL level
        move    x:TTL3,a1              ; Read in the TTL byte
...
;***************************************************************************
; Set TTL level
        move    x:TTL8,a1              ; Read in the TTL byte
        not     a                       ; Invert the byte
        move    y:TTL,x1                ; Read the current TTL state
        and     x1,a1                   ; And with current TTL state to switch off TTL line
        move    a1,y:TTL                ; Save new TTL state
